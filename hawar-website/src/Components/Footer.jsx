        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
          ...
          <div className="text-center md:text-right">
            ...
            <ul className="space-y-3">
              <li>
                <a href="/" className="text-lg hover:text-hawar-orange transition">
                  الرئيسية
                </a>
              </li>
              <li>
                <a href="/about" className="text-lg hover:text-hawar-orange transition">
                  عن النادي
                </a>
              </li>
              <li>
                <a href="/contact" className="text-lg hover:text-hawar-orange transition">
                  النشاط الرياضى
                </a>
              </li>
              <li>
