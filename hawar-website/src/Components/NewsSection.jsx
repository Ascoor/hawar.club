        ...
        <div className="news-list">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="news-box bg-white p-6 rounded-lg shadow-md relative">
              ...
              <h4 className="text-xl font-semibold mt-4">
                <a
                  ...
                  className="text-gray-800 hover:text-hawar-orange"
                >
                  افتتاح صالة الألعاب الجديدة
                </a>
              </h4>
              <p className="mt-2 text-gray-600">
                يسر نادي الرياض أن يعلن عن افتتاح صالة الألعاب الرياضية الحديثة
                التي تم تجهيزها بأحدث المعدات الرياضية.
                <a
                  href="news-detail.html"
                  className="text-hawar-blue-dark hover:text-hawar-blue"
                >
                  المزيد...
                </a>
              </p>
            ...
            <div className="news-box bg-white p-6 rounded-lg shadow-md relative">
              ...
              <h4 className="text-xl font-semibold mt-4">
                <a
                  ...
                  className="text-gray-800 hover:text-hawar-orange"
                >
                  بطولة الربيع السنوية
                </a>
              </h4>
              <p className="mt-2 text-gray-600">
                انطلاق بطولة الربيع السنوية في نادي الرياض، حيث يتنافس الأعضاء
                على أفضل أداء في مختلف الألعاب الرياضية.
                <a
                  href="news-detail.html"
                  className="text-hawar-blue-dark hover:text-hawar-blue"
                >
            ...
            <div className="news-box bg-white p-6 rounded-lg shadow-md relative">
              ...
              <p className="mt-2 text-gray-600">
                يطلق نادي الرياض برنامج التدريب الصيفي المخصص للأطفال والشباب
                لتعزيز مهاراتهم الرياضية وتنمية لياقتهم البدنية.
                <a
                  href="news-detail.html"
                  className="text-hawar-blue-dark hover:text-hawar-blue"
                >
