  ...
  const featureClasses = [
    {
      ...
      date: "أغسطس 2021",
      time: "10:00 م",
      title: "افتتاح المرحلة الجديدة لتوسعة نادي الحوار الرياضي بالمنصورة، والتي شملت تطوير المنشآت لتقديم خدمات أفضل للأعضاء.",
    },
    {
      image: News2,
      date: "21 أبريل 2022",
      time: "11:38 م",
      title: "زيارة وزير الشباب والرياضة لنادي الحوار الرياضي بمدينة المنصورة، حيث أشاد بالمستوى المتميز للخدمات والمنشآت.",
    },
    {
      image: News3,
      date: "مايو 2022",
      time: "12:00 م",
      title: "نادي الحوار يستضيف نقطة ختام ماراثون 'قادرين' وينظم يومًا رياضيًا حافلًا بالأنشطة الترفيهية والرياضية.",
    },
    {
      image: News4,
      date: "يونيو 2023",
      time: "9:00 ص",
      title: "بطلات نادي الحوار لكرة اليد ناشئات مواليد 2012 يحققن فوزهن الثاني على نادي النصر في بطولة الجمهورية لكرة اليد.",
    },
    {
      image: News5,
      date: "أغسطس 2023",
      time: "3:00 م",
      title: "أبطال نادي الحوار لكرة اليد مواليد 2010 ينتصرون بفارق كبير على نادي جزيرة الورد ضمن فعاليات بطولة منطقة الدقهلية.",
    },
    {
      image: News6,
      date: "ديسمبر 2022",
      time: "5:00 م",
      title: "فريق كرة القدم مواليد 2011 بنادي الحوار يتصدر مجموعته بدون هزيمة بعد الفوز على نبروه في دوري منطقة الدقهلية.",
    },
  ];

  return (
    <div className="building-outer py-12 bg-hawar-blue-dark">
        ...
        >
          {featureClasses.map((feature, index) => (
            <SwiperSlide key={index}>
              <div className="px-4">
                <div
                  className="relative feature-box bg-hawar-blue-darker p-6 rounded-lg shadow-md overflow-hidden h-[380px] flex flex-col justify-between"
                  data-aos="fade-up"
                >
                    ...
                    <h4 className="text-xl font-semibold mt-4 text-center text-white">
                      ...
                      {feature.title.length > 50 && (
                        <button
                          ...
                          className="text-orange-500 text-sm hover:underline ml-2"
                        >
