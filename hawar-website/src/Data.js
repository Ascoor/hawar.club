...
import trainer8 from './assets/gym/gym-team2.jpg';
  ...
  const slogans = [
      { id: 'slogan-1', text: 'في نادي الحوار, نؤسس مجتمعًا ملهم يستطيع أن يحقق التغيير.' },
      {
          id: 'slogan-2',
          text: 'لأننا نؤمن بأن التعاون هو جوهر النجاح، والأساس الذي نبني عليه رؤيتنا.',
        },
    { id: 'slogan-3', text: 'رؤيتنا تتجاوز الحدود، لنحقق أثرًا لا يُنسى.' },
    { id: 'slogan-4', text: 'لنكمل تاريخ من الإنجازات، ومستقبل من الطموحات' },
    { id: 'slogan-5', text: 'الشغف هنا ليس مجرد فكرة.' },
    { id: 'slogan-6', text: 'بل هو الطريق نحو إنجازات ملموسة.' },
    { id: 'slogan-7', text: 'نسعى دائمًا لنرتقي إلى قمم التميز، يدًا بيد.' },
    { id: 'slogan-8', text: 'كن جزءًا من الحدث' },
