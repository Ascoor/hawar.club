...
const HeroSection = () => {
  ...
  return (
    <section id='home' className='w-screen min-h-screen bg-hero-pattern bg-cover bg-fixed bg-right max-sm:bg-center max-lg:bg-center'>
      <motion.div 
        ...
        <p className='text-[#f04e3c] relative before:absolute before:w-20 before:h-1 before:bg-[#f04e3c] before:top-[50%] before:right-0 pr-24 text-2xl before:translate-y-[-50%] max-sm:text-xl max-sm:before:w-14 max-sm:pr-20'>
          مع باتريك بوتر
        </p>
        ...
        <div className='my-12 text-8xl max-lg:text-7xl text-white max-w-[60%] max-xl:max-w-[70%] max-lg:max-w-[80%] max-md:max-w-[100%] max-sm:text-3xl'>
          <h1>بناء جسم مثالي لحياة صحية وطويلة.</h1>
        </div>
