...
const eventNews = [
  ...
  },
  {
    id: 5,
    image: News6,
    date: 'الجمعة 25 أغسطس 2023',
    time: '9:00 ص',
    title:
      'مجلس إدارة النادي برئاسة المحاسب /إيهاب صفوت فوده يستقبل أبطال كرة اليد مواليد ٢٠٠٤ الحاصلين علي المركز الأول في بطولة النصر السابعة ببورسعيد وقدم مجلس إدارة النادي التهنئه للاعبين والجهاز الفني والإداري.',
  },
  {
    id: 6,
    image: News5,
    date: 'الإثنين 12 ديسمبر 2022',
    time: '5:00 م',
    title:
      'أبطال نادي الحوار لكرة القدم مواليد ( ٢٠٠٥ ) يضيفوا انتصار جديد لقطاع كرة القدم بفوزهم اليوم على فريق شها المحترم فى عقر داره ووسط جماهيره بنتيجة ٤ /١ .',
  },
];
